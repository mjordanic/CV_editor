...
class CVWriterAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            model: The LLM model identifier to use for CV generation
        ...
        logger.debug(f"CVWriterAgent filter LLM initialized - model: {filter_model}, temperature: {filter_temperature}")
